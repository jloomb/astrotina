...
export declare function SidebarProvider({ position, resizingSidebar, setResizingSidebar, defaultWidth, defaultState, sidebar, }: SidebarProviderProps): JSX.Element;
